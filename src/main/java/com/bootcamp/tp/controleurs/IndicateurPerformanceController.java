 ...
 * @author kiki
 */
public class IndicateurPerformanceController extends ParentController implements Serializable {

	public IndicateurPerformanceController(EntityManager em, BaseEntite entite) {
		super(em, entite);
